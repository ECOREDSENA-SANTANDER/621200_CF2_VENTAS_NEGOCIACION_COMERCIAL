  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5.mb-5
    ...
    .row.justify-content-center.align-items-center(data-aos="fade-right")
      ...
      .col-lg-4.col-md-7.col-7.mb-4
        img.img-a.img-t(src='@/assets/curso/temas/Tema1/img11.png', alt='tema1')
    ...
    .row.justify-content-center.mb-0(data-aos="fade-right")
      ...
      .col-lg-8
        .bloque-texto-f.comillas.pt-4.px-5.mb-5
          ...
          h4.text-regular.bloque-texto-f__texto El Gobierno o las dependencias de Gobierno actúan como clientes en este mercado, puesto que compran los bienes y servicios de otras empresas para ulteriormente  ofrecer servicios públicos.  
            br
            br
            p.mb-0  (Quiroa, 2020).
      ...
      .col-lg-10
        .bloque-texto-g.color-secundario.p-3.p-sm-4.p-md-5
          ...
          .bloque-texto-g__texto.p-4
            p.mb-0 Los países procuran exportar  los bienes y servicios donde tienen excedentes e importar aquellos bienes y servicios donde no tienen ventajas competitivas. <br><br>
            p Entiéndase como ventaja competitiva aquella que tiene la empresa de un sector con mayor capacidad para  producir algo con atributos y características muy por encima de su competencia. 
